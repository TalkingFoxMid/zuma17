...
class EndGameWinWidget(QWidget):
    ...
    def handle_timer(self):
        ...
        self.qp.drawPixmap(150, 100, 500,150, QPixmap("resources/pobeda_text.png"))
        self.qp.drawPixmap(100, 300, 500, 150, QPixmap("resources/you_get_score.png"))
        ...
        self.qp.drawPixmap(0, 500, 200, 150, QPixmap("resources/paste_nick.png"))
